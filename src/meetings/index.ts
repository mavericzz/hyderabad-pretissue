...
export const GENERATED_MEETINGS = [
  ...
  },
  {
    id: "pun-2026-09-27",
    date: "2026-09-27",
    dateTab: dateTab("2026-09-27"),
    center: "pun",
    centerLabel: labelForCenter("pun"),
    short: "PUN",
    hasNight: Boolean(pun20260927Night),
    extraCopy: false,
    meta: pun20260927Meta,
    races: pun20260927Races as unknown as Race[],
    sheet: pun20260927Sheet as unknown as SheetMeeting,
    results: [] as RaceResult[],
    resultSource: "",
    swim: [] as SwimEntry[],
    night: pun20260927Night ?? undefined,
  },
  {
    id: "hyd-2026-09-28",
    date: "2026-09-28",
    dateTab: dateTab("2026-09-28"),
    center: "hyd",
    centerLabel: labelForCenter("hyd"),
    short: "HYD",
    hasNight: Boolean(hyd20260928Night),
    extraCopy: false,
    meta: hyd20260928Meta,
    races: hyd20260928Races as unknown as Race[],
    sheet: hyd20260928Sheet as unknown as SheetMeeting,
    results: [] as RaceResult[],
    resultSource: "",
    swim: [] as SwimEntry[],
    night: hyd20260928Night ?? undefined,
  }
];
